...
module ::DiscordBot::DiscordEventsHandlers
  ...
  module TransmitAnnouncement
    ...
    message do |event|
      ...
      run = !SiteSetting.discord_bot_auto_channel_sync && SiteSetting.discord_bot_discourse_announcement_topic_id.blank? && (event.message.channel.id != SiteSetting.discord_bot_announcement_channel_id)
